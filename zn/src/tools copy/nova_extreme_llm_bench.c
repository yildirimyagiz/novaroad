...
int main() {
  ...
  // 1. MatMul: 4096 x 4096 x 4096
  {
    ...
    NovaTensor *tA = nova_tensor_create(NULL, shA, 2, NOVA_DTYPE_FP32);
    NovaTensor *tB = nova_tensor_create(NULL, shB, 2, NOVA_DTYPE_FP32);
    NovaTensor *tBias =
        nova_tensor_create(NULL, (int64_t[]){N}, 1, NOVA_DTYPE_FP32);
    NovaTensor *tOut = nova_tensor_create(NULL, shO, 2, NOVA_DTYPE_FP32);
  ...
  for (int s_idx = 0; s_idx < 2; s_idx++) {
    ...
    NovaTensor *tQ = nova_tensor_create(NULL, shape, 4, NOVA_DTYPE_FP32);
    NovaTensor *tK = nova_tensor_create(NULL, shape, 4, NOVA_DTYPE_FP32);
    NovaTensor *tV = nova_tensor_create(NULL, shape, 4, NOVA_DTYPE_FP32);
    NovaTensor *tO = nova_tensor_create(NULL, shape, 4, NOVA_DTYPE_FP32);
