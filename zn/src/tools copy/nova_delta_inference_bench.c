...
void run_delta_bench() {
  ...
  NovaTensor *delta = nova_tensor_create(NULL, s_mat, 2, NOVA_DTYPE_FP32);
  NovaTensor *weights =
      nova_tensor_create(NULL, s_weight, 2, NOVA_DTYPE_FP32);
  NovaTensor *output_full =
      nova_tensor_create(NULL, s_mat, 2, NOVA_DTYPE_FP32);
