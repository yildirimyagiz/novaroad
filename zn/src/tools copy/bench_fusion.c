...
int main(void) {
  ...
  for (int si = 0; si < n_sizes; si++) {
    ...
    NovaTensor *A = nova_tensor_create(NULL, shape_a, 2, NOVA_DTYPE_FP32);
    NovaTensor *B = nova_tensor_create(NULL, shape_b, 2, NOVA_DTYPE_FP32);
    NovaTensor *Bias =
        nova_tensor_create(NULL, shape_bias, 1, NOVA_DTYPE_FP32);

    // Output tensors for each path
    NovaTensor *Out_eager =
        nova_tensor_create(NULL, shape_out, 2, NOVA_DTYPE_FP32);
  ...
  for (int si = 0; si < n_conv_sizes; si++) {
    ...
    NovaTensor *X = nova_tensor_create(NULL, shape_x, 4, NOVA_DTYPE_FP32);
    NovaTensor *Weight =
        nova_tensor_create(NULL, shape_w, 4, NOVA_DTYPE_FP32);
    NovaTensor *Bias =
        nova_tensor_create(NULL, shape_b, 1, NOVA_DTYPE_FP32);
    NovaTensor *Out_eager =
        nova_tensor_create(NULL, shape_out, 4, NOVA_DTYPE_FP32);
    NovaTensor *Out_fused =
        nova_tensor_create(NULL, shape_out, 4, NOVA_DTYPE_FP32);
    NovaTensor *Tmp =
        nova_tensor_create(NULL, shape_out, 4, NOVA_DTYPE_FP32);
  ...
  for (int si = 0; si < n_attn_sizes; si++) {
    ...
    NovaTensor *Q =
        nova_tensor_create(NULL, shape_qkv, 4, NOVA_DTYPE_FP32);
    NovaTensor *K =
        nova_tensor_create(NULL, shape_qkv, 4, NOVA_DTYPE_FP32);
    NovaTensor *V =
        nova_tensor_create(NULL, shape_qkv, 4, NOVA_DTYPE_FP32);
