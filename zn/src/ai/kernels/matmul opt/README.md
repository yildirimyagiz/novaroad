...
```
zenith_ultra/
├── zenith_matmul.h      # Header: tüm sabitler, struct'lar, API
├── zenith_matmul.c      # CPU backend: blocked + SIMD + INT8 + adaptive
├── zenith_matmul.metal  # GPU kernels: FP32/FP16/INT8 + softmax
