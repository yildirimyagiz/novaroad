...
#ifndef NOVA_LLVM_CODEGEN_H
#define NOVA_LLVM_CODEGEN_H

#include "nova_ast.h"
#include "../ml/nova_optimizer.h"
#include "../system/nova_policy.h"
...
#else
// Forward declarations for LLVM types to allow compilation/IDE analysis without LLVM
