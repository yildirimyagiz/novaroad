...
CASES: List[Tuple[str, List[str], str]] = [
    ("IRType", ['Void', 'Bool', 'I8', 'I16', 'I32', 'I64', 'U8', 'U16', 'U32', 'U64', 'F16', 'F32', 'F64', 'Ptr(Box<IRType>)', 'Array(Box<IRType>, usize)', 'Vector(Box<IRType>, usize)', 'Struct(Vec<IRType>)', 'Function(Vec<IRType>, Box<IRType>)', 'Tensor {\n        element_ty: Box<IRType>,\n        data: Vec<i64>,\n    }', 'Named(String)'], "IRType definition"),
]

@dataclass
class TypesCompilerGenerator:
    ...
    def emit_c_header(self) -> str:
        ...
        for group_name, variants, doc in self.cases:
            ...
            for var in variants:
                ...
                output += f"#define NOVA_TYPES_{group_name.upper()}_{v_clean} {tag}\n"
            output += "\n"
        output += "#endif\n"
        return output
...
def main():
    ...
    args = p.parse_args()
    c = TypesCompilerGenerator().compile()
