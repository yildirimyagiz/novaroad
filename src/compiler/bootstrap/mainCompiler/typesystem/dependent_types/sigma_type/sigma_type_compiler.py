...
@dataclass
class SigmaTypeCompilerGenerator:
    ...
    def emit_python_enums(self) -> str:
        ...
        output += "\n@dataclass\nclass MobileConstructionInfo:\n    pass\n\n@dataclass\nclass MobileSigmaContext:\n    pass\n\n@dataclass\nclass MobileSubsetConstraints:\n    pass\n\n@dataclass\nclass PairConstructionProfile:\n    pass\n\n@dataclass\nclass SigmaType:\n    pass\n\n@dataclass\nclass SigmaValue:\n    pass\n\n@dataclass\nclass SubsetType:\n    pass\n\n"
    ...
    def emit_c_header(self) -> str:
        guard = f"NOVA_SIGMA_TYPE_TAGS_H"
        ...
        for group_name, variants, doc in self.cases:
            ...
            for var in variants:
                ...
                output += f"#define NOVA_SIGMA_TYPE_{group_name.upper()}_{v_clean} {tag}\n"
            output += "\n"
        output += "#endif\n"
        return output
...
def main():
    ...
    args = p.parse_args()
    c = SigmaTypeCompilerGenerator().compile()
