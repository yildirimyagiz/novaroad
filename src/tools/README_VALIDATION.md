# Novaific Performance & Efficiency Validation Suite

## Overview

This is a **non-simulated, hardware-realistic performance validation suite** for the Nova. Unlike synthetic benchmarks, this suite executes real computation workloads and validates results with checksums.
...
Same as Nova (see parent LICENSE file)

## Contact

For questions or issues with the validation suite, please file an issue in the main Novatory.
