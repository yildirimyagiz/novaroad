/**
 * Test for Nova 2.0 Features: Enums and Match
 */
...
int main() {
  ...
  printf("Testing Nova 2.0 Enums and Match...\n");
  ...
  // CodeGen
  CodeGen *cg = codegen_create("test_nova_2_0");
  codegen_node(cg, ast);
  if (cg->had_error) {
    printf("CodeGen failed.\n");
    yield 1;
  }
  printf("CodeGen successful. IR Dump:\n");
  codegen_dump_ir(cg);
